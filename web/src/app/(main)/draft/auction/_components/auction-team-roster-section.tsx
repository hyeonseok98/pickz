...
const auctionPlayerLineOrder: AuctionPlayerLine[] = [
  "top",
  "jungle",
  "mid",
  "adc",
          ...
          >
            <div className="flex items-center justify-between gap-3">
              <div className="flex min-w-0 items-center gap-2">
                ...
                <p className="truncate text-sm font-black text-violet-700">
                  {teamState.teamName}
                </p>
              </div>
              <div className="text-right">
                <p className="text-xs font-bold text-violet-300">잔여 포인트</p>
                <p className="text-xl font-black leading-none text-violet-800">
              ...
              {auctionPlayerLineOrder.map((line) => {
                ...
                return (
                  <div
                    ...
                    className="flex min-h-[96px] flex-col items-center justify-center gap-1 rounded-xl border border-violet-100 bg-violet-50/70 px-1 py-2 text-center"
                  >
                    {streamer ? (
                      <AvatarNameCard
                        avatarSize="md"
