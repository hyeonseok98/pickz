...
export default function Page() {
  return (
    <main
      id="home"
      className="flex min-h-screen bg-[linear-gradient(180deg,#ffffff_0%,#f6f8fc_100%)] text-text-primary"
    >
      <div className="flex w-full">
        <MenuSidebarExample />

        <section className="flex flex-1 flex-col px-8 py-6" aria-label="빈 콘텐츠 영역">
